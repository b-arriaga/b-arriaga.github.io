                ...
                <div className="w-full md:w-1/2 p-12 md:p-24 flex flex-col justify-center bg-[#F5F5F5]">
                  <div className="max-w-xl">
                    ...
                    <div className="mt-12 flex flex-col sm:flex-row gap-6">
                      <a 
                        href="/Arriaga_Bellissima_Resume.pdf" 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="relative flex-1 group"
                      >
                        <div className="absolute inset-0 bg-[#ff4791] translate-x-1 translate-y-1 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform" />
                        <div className="relative border-2 border-[#1A1A1A] bg-[#1A1A1A] p-4 flex items-center justify-center gap-2 text-white font-mono-bold uppercase tracking-widest text-sm transition-colors group-hover:bg-[#ff4791]">
                          <Download size={18} /> Download Resume
                        </div>
                      </a>
                      <a 
                        href="https://www.linkedin.com/in/bellissima-arriaga"
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="relative flex-1 group"
                      >
                        {/* Shadow Layer */}
                        <div className="absolute inset-0 bg-[#1A1A1A] translate-x-1 translate-y-1 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform" />
                        
                        {/* Button Face */}
                        <div className="relative border-2 border-[#1A1A1A] bg-[#ff4791] p-4 flex items-center justify-center gap-2 text-white font-mono-bold uppercase tracking-widest text-sm transition-colors group-hover:bg-[#1A1A1A]">
